...
#################################################################################
 # class name       : SecA2B_tb
 # description      : generate SecA2B_tb system verilog file
 #                    
 # returns          : this class
 # algorithm        : 
 #                    no 
...
class SecA2B_tb:
    ...
    def my_signals(self, share, width):
        ...
        num_of_x_y  = share
        W = int(math.log(width,2))
        signals = [
            ("clk_i"    , 0),
            ("rst_ni"   , 0),
            ("i_dvld"   , 0),
            ("i_rvld"   , 0),
            ("i_n"      , self.list_instname.r_len*width),
    ...
    def instance_SecA2B_ports(self):
    ...
    def write(self):
        ...
        raw += gen_rand(logics[0].get_name(), 15, logics[4].get_name(), self.list_instname.r_len, self.width, True)
        ...
        inst_parameters     = []
        inst_ports          = self.instance_SecA2B_ports()
        inst_fraw           = "";
        inst_praw           = "";
